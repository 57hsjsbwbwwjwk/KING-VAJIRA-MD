...
global.sudo = process.env.SUDO || '94742678276'
global.devs = '94742678276';
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? '*•.¸♡ ＳＡＤＵＰＡ ＭＤ ＷＰ ＢＯＴ ♡¸.•*' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? '*•.¸♡ ＳＡＤＵＰＡ ＭＤ ＷＰ ＢＯＴ ♡¸.•*' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? 'VAJIRA;;;SausagesManny' : process.env.SESSION_ID,
